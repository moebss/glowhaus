export default function Datenschutz({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-darker border border-light/10 p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto text-light/70" onClick={e => e.stopPropagation()}>
        <div className="flex justify-between items-center mb-6 border-b border-light/10 pb-4">
