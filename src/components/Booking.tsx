      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            ...
            <h3 className="font-serif text-4xl md:text-6xl text-light leading-tight mb-12">Dein Glow <span className="italic text-light/80">Moment</span></h3>
            ...
            <div className="mt-12">
              ...
              <div className="w-full h-64 rounded-sm overflow-hidden border border-light/5 grayscale hover:grayscale-0 transition-all duration-500">
                <iframe 
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="bg-anthracite p-8 md:p-12 border border-light/5">
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input id="name" name="name" type="text" required className="bg-darker border border-light/10 rounded-sm p-4 text-light focus:outline-none focus:border-gold transition-colors w-full" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-xs uppercase tracking-widest text-light/50 mb-2">E-Mail</label>
                    <input id="email" name="email" type="email" required className="bg-darker border border-light/10 rounded-sm p-4 text-light focus:outline-none focus:border-gold transition-colors w-full" />
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select className="bg-darker border border-light/10 rounded-sm p-4 text-light focus:outline-none focus:border-gold transition-colors appearance-none w-full">
                  ...
                  <div>
                    ...
                    <input id="size" name="size" type="text" placeholder="z.B. 10x10 cm" className="bg-darker border border-light/10 rounded-sm p-4 text-light focus:outline-none focus:border-gold transition-colors w-full" />
                  </div>
                </div>
                
                <div>
                  <label htmlFor="placement" className="block text-xs uppercase tracking-widest text-light/50 mb-2">Körperstelle</label>
                  <input id="placement" name="placement" type="text" placeholder="z.B. Rechter Unterarm" className="bg-darker border border-light/10 rounded-sm p-4 text-light focus:outline-none focus:border-gold transition-colors w-full" />
                </div>
                
                <div>
                  <label className="block text-xs uppercase tracking-widest text-light/50 mb-2">Beschreibung</label>
                  <textarea rows={4} required className="bg-darker border border-light/10 rounded-sm p-4 text-light focus:outline-none focus:border-gold transition-colors resize-none w-full" placeholder="Beschreibe deine Idee..."></textarea>
                </div>
                
                <div>
                  <label className="block text-xs uppercase tracking-widest text-light/50 mb-2">Referenzbilder</label>
                  <div className="w-full bg-darker border border-dashed border-light/20 rounded-sm p-8 text-center hover:border-gold transition-colors cursor-pointer group">
